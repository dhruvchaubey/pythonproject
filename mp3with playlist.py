...
class MainWindow(wx.Frame):
    ...
    def __init__(self,parent,id):
        wx.Frame.__init__(self,parent,id,'Music Player',size=(700,560),style=wx.MINIMIZE_BOX|wx.CAPTION|wx.CLOSE_BOX)
        ...
        #self.panel.SetBackgroundColour(wx.GREY)
        ...
        loadButton = wx.Button(bttnprt, -1, "Load File...", pos=(235,400), size=(80,30))
        self.Bind(wx.EVT_BUTTON, self.Load, loadButton)

        playButton = wx.Button(bttnprt, -1, "Play", pos=(320,440), size=(80,30))
        ...
        """volumeUpButton = wx.Button(bttnprt, -1, "Up", pos=(270,400), size=(80,30))
        self.Bind(wx.EVT_BUTTON, self.onSetVolumeUp, volumeUpButton)

        volumeDownButton = wx.Button(bttnprt, -1, "Down", pos=(370,400), size=(80,30))
        ...
        #self.volumeCtrl = wx.Slider(bttnprt, value=0, minValue=0, maxValue=100, pos=(580,440),size=(120,-1))
#        self.volumeCtrl.Bind(wx.EVT_SLIDER, self.onSetVolume)
        #self.volumeCtrl.Show()
        """slider2 = wx.Slider(bttnprt, -1,0, 0, 100, size=(120, -1),pos=(580,440))
        ...
        self.myListBox = listbox = wx.ListBox(bttnprt, -1,pos=(0,5),size=(200,480))
...
#        self.st_file = wx.StaticText(bttnprt, -1, "Blank", pos=(30,30))
    ...
    def Load(self, event):
        ...
        #(self, parent, message=FileSelectorPromptStr, defaultDir=EmptyString,
        #defaultFile=EmptyString, wildcard,
        #style=FD_DEFAULT_STYLE, pos=DefaultPosition)
